          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-4 items-center justify-center bg-white p-8 w-full">
              <div className="flex items-center justify-center gap-4">
                {pokemonDetails.types && pokemonDetails.types.length > 0 && pokemonDetails.types.map((item) => { return (<div style={{ backgroundColor: colorType[formattedName(item.type.name)] }} className="rounded-full px-10 py-2 text-white font-parkinsans font-bold">{formattedName(item.type.name)}</div>) })}
              </div>
